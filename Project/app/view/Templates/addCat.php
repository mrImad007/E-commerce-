  ...
  <form class="moreForms" action="<?= URLROOT?>ElectroSite/Public/admin/addCat" method="POST" enctype="multipart/form-data">
    ...
    <div>
      ...
      <div>
        ...
        <input type="text" name="descr" id="email" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="product description" />
      </div>
