					...
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							<a href="blog-detail.php" class="hov-img0 how-pos5-parent">
								<img src="<?= URLROOT ?>/ElectroSite/public/images/blog-04.jpg" alt="IMG-BLOG">
						...
						<div class="p-b-63">
							<a href="blog-detail.php" class="hov-img0 how-pos5-parent">
								<img src="<?= URLROOT ?>/ElectroSite/public/images/blog-05.jpg" alt="IMG-BLOG">
						...
						<div class="p-b-63">
							<a href="blog-detail.php" class="hov-img0 how-pos5-parent">
								<img src="<?= URLROOT ?>/ElectroSite/public/images/blog-06.jpg" alt="IMG-BLOG">
							...
							<ul>
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="<?= URLROOT ?>/ElectroSite/public/images/product-min-01.jpg" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="<?= URLROOT ?>/ElectroSite/public/images/product-min-02.jpg" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="<?= URLROOT ?>/ElectroSite/public/images/product-min-03.jpg" alt="PRODUCT">
									</a>
