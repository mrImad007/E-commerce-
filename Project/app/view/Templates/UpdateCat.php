...
<div class="p-8 rounded border border-gray-200">
  ...
  <form class="moreForms" action="<?= URLROOT?>ElectroSite/Public/admin/addCat" method="POST" enctype="multipart/form-data">
    ...
    <div>
      ...
      <div>
        ...
        <input type="text" name="name" id="email" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="product name" value="<?= $data['name']?>"/>
      </div>

      <div>
        <label for="email" class="text-sm text-gray-700 block mb-1 font-medium">Product description</label>
        <input type="text" name="descr" id="email" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="product description" value="<?= $data['descr']?>"/>
      </div>
...
<!-- end form -->
  ...
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      Cosmetics, Beauty category, fragrances and tools
    </p>
