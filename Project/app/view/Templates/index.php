...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(<?= URLROOT?>/ElectroSite/public/images/prods/slider1.jpg);">
				...
				<div class="item-slick1" style="background-image: url(<?= URLROOT?>/ElectroSite/public/images/prods/slider3.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(<?= URLROOT?>/ElectroSite/public/images/prods/slider2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc1.jpg" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04" src="<?= URLROOT ?>/ElectroSite/public/images/icons/icon-heart-01.png" alt="ICON">
								</a>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc2.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc3.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc4.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc5.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc6.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc7.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= URLROOT ?>/ElectroSite/public/images/prods/pc8.jpg" alt="IMG-PRODUCT">
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="<?= URLROOT ?>/ElectroSite/public/images/icons/icon-close.png" alt="CLOSE">
				</button>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= URLROOT ?>/ElectroSite/public/images/product-detail-01.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= URLROOT ?>/ElectroSite/public/images/product-detail-02.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= URLROOT ?>/ElectroSite/public/images/product-detail-03.jpg" alt="IMG-PRODUCT">
...
<!--===============================================================================================-->
	<script src="<?= URLROOT?>/ElectroSite/public/vendor/daterangepicker/moment.min.js"></script>
	<script src="<?= URLROOT?>/ElectroSite/public/vendor/daterangepicker/daterangepicker.js"></script>
<!--===============================================================================================-->
	<script src="<?= URLROOT?>/ElectroSite/public/vendor/slick/slick.min.js"></script>
	<script src="<?= URLROOT?>/ElectroSite/public/js/slick-custom.js"></script>
<!--===============================================================================================-->
	<script src="<?= URLROOT?>/ElectroSite/public/vendor/parallax100/parallax100.js"></script>
	<script>
...
<!--===============================================================================================-->
	<script src="<?= URLROOT?>/ElectroSite/public/vendor/isotope/isotope.pkgd.min.js"></script>
<!--===============================================================================================-->
	<script src="<?= URLROOT?>/ElectroSite/public/vendor/sweetalert/sweetalert.min.js"></script>
	<script>
