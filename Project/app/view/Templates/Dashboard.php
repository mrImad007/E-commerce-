                ...
                <div class="text-white">
                    <div class="flex p-2  bg-gray-800">
                        <div class="flex py-3 px-2 items-center">
                            <p class="text-2xl text-green-500 font-semibold">Electro</p>
                            <p class="ml-2 font-semibold italic">Maroc</p>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <div class="">
                            <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 border-green-400"
                                src="<?= URLROOT?>ElectroSite/public/images/1.jpg" alt="admin">
                            <p class="font-bold text-base  text-gray-400 pt-2 text-center w-24">Imad</p>
                        </div>
                    </div>
                    <div>
                        <ul class="mt-6 leading-10">
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    href="<?= URLROOT?>ElectroSite/Pages/index">
                                ...
                                <ul x-transition:leave="transition ease-in duration-150"
                                    ...
                                    <li class="flex">
                                        <a class=" text-white inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800"
                                            href="<?= URLROOT?>ElectroSite/public/Admin/showcat">
                            ...
                            <div class="col-span-12 mt-5">
                                <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                                    <div class="bg-white p-4 shadow-lg rounded-lg">
                                        <h1 class="font-bold text-base">Produits</h1>
                                        <div class="mt-4">
                                                                ...
                                                                <tbody class="bg-white divide-y divide-gray-200">
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <p><?php echo $product['label']?></p>
                                                                        </td>
                                                                        <td
                                                                            class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                            <p><?php echo $product['sellP']?> MAD</p>
                                                                        </td>
                                                                        <td
                                                                            class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="flex space-x-4">
                                                                                ...
                                                                                <form action="<?= URLROOT?>ElectroSite/Public/Admin/single" method="post">
                                                                                ...
                                                                                <form class="text-red-500 hover:text-red-600" action="<?= URLROOT?>ElectroSite/public/Admin/delete" method="post">
                                                                                    <button type="submit">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <div class="py-2 align-middle inline-block min-w-full">
                                                        <div
                                                            ...
                                                            <table class="min-w-full divide-y divide-gray-200">
                                                                ...
                                                                <!-- start loop -->
                                                                <?php foreach($data['commands'] as $commands):?>
                                                                <tbody class="bg-white divide-y divide-gray-200">
                                                                    <tr>
                                                                        <td
                                                                            class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="flex space-x-4">
                                                                                ...
                                                                                <form action="<?= URLROOT?>ElectroSite/Public/User/acceptCommands" method="post">
                                                                                ...
                                                                                <form class="text-red-500 hover:text-red-600" action="<?= URLROOT?>ElectroSite/public/User/rejectCommands" method="post">
                                                                                    <button type="submit">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                                            class="w-5 h-5 mr-1 ml-3"
                                                                                            fill="none" viewBox="0 0 24 24"
